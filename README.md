...
访问时间: 2024-06-15 12:30:00
修改时间: 2024-12-31 23:59:59
```
...
示例：
```bash
chmate test.txt "2024-05-20 10:30:00"
```

这会将创建时间、访问时间、修改时间都设置为 `2024-05-20 10:30:00`。

### 3. 分别设置三个时间

```bash
chmate <文件路径> "<创建时间>" "<访问时间>" "<修改时间>"
```

示例：
```bash
chmate test.txt "2024-01-01 08:00:00" "2024-06-15 12:30:00" "2024-12-31 23:59:59"
```
